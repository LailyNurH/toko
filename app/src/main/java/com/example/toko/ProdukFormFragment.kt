...
private val api by lazy { BaseRetrofit().endpoint }
    ...
    override fun onCreateView(
       ...
       val view=  inflater.inflate(R.layout.fragment_produk_form, container, false)
        ...
        val btnProsesProduk = view.findViewById<Button>(R.id.btnProses)
...
//                Toast.makeText(activity?.applicationContext, "Data Berhasil diInput", Toast.LENGTH_SHORT).show()
                ...
                api.putProduk(token.toString(),produk?.id.toString().toInt(),adminId.toString().toInt(),txtFormNama.text.toString()
